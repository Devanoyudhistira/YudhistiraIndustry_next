...
export default function Failed() {
    return (
        <div className="flex flex-col w-screen px-4 h-max items-center justify-evenly" >
            ...
            <p className="text-md mt-3 font-semibold text-center text-zinc-500" > Ada masalah saat pembuatan produk silahkan coba lagi. tolong cek koneksi anda dan coba lagi </p>
