...
export default async function Updateproduct({params}) {
    ...
    return (
        <div className=" scroll-smooth overflow-y-auto w-max  -mt-2" >
            ...
            <Formaction orignalid={data.id} originalimage={data.Product_image.trimEnd()} createaction={update} originaltext={data.nama_barang} originalprice={data.harga} originalstock={data.jumlah} originaldesc={data.description} />            
        </div>
    )
}