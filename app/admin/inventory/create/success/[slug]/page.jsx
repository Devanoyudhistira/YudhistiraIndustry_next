...
export default async function Successcreate({ params }) {
    ...
    return (
        ...
        <div className="flex flex-col overflow-x-hidden px-1 items-center justify-evenly " >
            <div className="flex items-center shadow-xl shadow-green-400/40 justify-center rounded-xl bg-green-300 text-green-500 p-4 " > <CheckCircle size={50}/> </div>
            <h1 className="text-2xl font-semibold mt-2" > Product Berhasil Di Buat </h1>
            ...
            <section className="grid w-screen px-5 py-1 h-50 rounded-xl mt-5 bg-zinc-50 grid-cols-2  gap-3" >
                <div className="bg-green-300/80 w-full h-max px-2 py-4 rounded-xl col-span-2 text-center" >
                    <h1 className="font-green text-2xl tracking-wider capitalize " > Nama Produk </h1>
                    <p className="font-semibold text-xl tracking-wide" >  {data.nama_barang} </p>
                </div>
                <div className="bg-green-300/80 w-full h-max px-2 py-4 rounded-xl  text-center" >
            ...
            <div className="w-full h-max px-2 py-1 flex flex-col gap-2" >
                ...
                <Link className="bg-emerald-200 w-full transition focus:scale-90 h-12 py-1 rounded-xl text-zinc-950 font-bold text-xl flex items-center justify-center gap-1 capitalize" href={"/admin/inventory/create"}> Buat Produk Lagi <Plus size={40} /> </Link>                
            </div>
        </div>
