...
export default async function Admin() {    
    const invoicedata = await supabase.from("invoice_new").select("*")    
    return (
        <>
        ...
        <div className="w-screen scrollbar scroll-smooth px-2 grid grid-flow-col gap-10 overflow-x-auto overflow-y-hidden h-auto py-2 " >
            <Infocard icon={<GraphUp size={30} className="text-green-500" /> } invoname={"total pemasukan"} invovalue={"Rp.100.000.000"} />
