...
export default function Selleditem({nama,stok,Terjual,gambar}) {
    return (
        <div className="w-full h-max  rounded-xl bg-zinc-50 shadow-xs  shadow-zinc-900 flex-col py-2" >
            <div className="w-full gap-2 px-2 flex justify-start" >
                ...
                <h2 className="text-xs justify-self-end font-medium bg-green-300 h-min w-max px-2 py-1 rounded-md" > In stock </h2>
            </div>
