...
export default function Popularitem({ gambar, nama, stock, terjual, tanggal,urutan ,harga}) {
    return (
        <div className="w-77 h-max bg-white shadow-xs rounded-xl flex flex-col items-center py-2 px-2 relative" >
            <div className="absolute z-1000 text-white w-max h-max px-2 py-2 rounded-full text-xl bg-yellow-500 tp-10 left-5" > {urutan + 1}# </div>
            ...
            <div className="w-full flex justify-between mt-2 border-t border-gray-500 items-center" >
                <div className="text-[12.5px] px-4 text-center mt-1" >
                    ...
                    <h2 className="font-semibold text-green-300" > tersisa {stock} </h2>
                </div>
