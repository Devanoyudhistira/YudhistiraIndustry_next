                ...
                data.map(e =>
                    <Link key={e.id} href={`/product/${e.id}`} >
                        <div className="bg-zinc-50 shadow-xs shadow-zinc-900 flex flex-col items-center justify-evenly py-3 px-1.5 h-max w-45  rounded-xl" >
                            <Image width={120} height={120} alt={e.nama_barang} loading="eager" src={e.Product_image} id="mockup-image" className="h-60 object-center object-cover w-full bg-black rounded-md " />
